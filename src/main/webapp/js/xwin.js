...
//**载入CSS*****
var xWinCssFilePath="..\/css\/xwin.css";
...
function _xWin_event_doInit(element){
	...
	element.hover='orange';
	element.minButton="../images/xwin/xwin_min.gif";
	element.maxButton="../images/xwin/xwin_max.gif";
	element.normalButton="../images/xwin/xwin_normal.gif";
	element.closeButton="../images/xwin/xwin_close.gif";
	...
	img.src='../images/xwin/xwin_title_head.png';
	element.oTitle.appendChild(img);
	...
	//设置窗口标题最小化按钮
	element.oTitleMButton=element.ownerDocument.createElement("img");
	...
	element.oTitleMButton.src=element.minButton;
	
	//设置窗口标题最大化按钮
	element.oTitleMaButton=element.ownerDocument.createElement("img");
	...
	element.oTitleMaButton.src=element.maxButton;
	
	//设置窗口标题关闭按钮
	element.oTitleCButton=element.ownerDocument.createElement("img");
	...
	element.oTitleCButton.src=element.closeButton;
...
function _xWin_method_Max(reV){
	if(this._windowState=="maximize"&&(!reV)){
		...
		this.oTitleMButton.src = this.minButton;
		this.oTitleMaButton.src = this.maxButton;
		...
		this.ResizeTo(w,h);
		this.oTitleMButton.src = this.minButton;
		this.oTitleMaButton.src = this.normalButton;
...
function _xWin_method_Min(reV){
	if(this._windowState=="minimize"&&(!reV)){
		...
		this.minIndex=i;
		this.oTitleMButton.src = this.normalButton;
		this.oTitleMaButton.src = this.maxButton;
