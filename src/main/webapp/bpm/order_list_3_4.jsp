        ...
        <tr>
            ...
            <td>
                <select id="orderState" name="orderState">
                    <option value="3">未分单</option>
                    <option value="4">已分单</option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td align="center" colspan="3">
                <button type="button" style="width: 100%" onclick="getOrderPage()">查询</button>
            </td>
        </tr>
    </table>
</form>
...
<SCRIPT LANGUAGE="JavaScript" >
    ...
    orderXTable.XTbodyArray = function (model) {
        var href = "";
        <%--href += "<a style='border-right: 1px solid #dddddd' href='${ctx}/bpm/order_manage_3_4_report.jsp?orderId=" + model.orderId + "'>报单&nbsp;</a>";--%>
        href += "<a style='border-right: 1px solid #dddddd' href='${ctx}/bpm/order_manage_3_4_survey.jsp?userId=${userId}&orderId=" + model.orderId + "&estateId=" + model.estateId + "&buildingId=" + model.buildingId + "&unitId=" + model.unitId + "&houseId=" + model.houseId + "&sampleId=" + model.sampleId + "&orderValuatorDept=" + model.orderValuatorDept + "'>&nbsp;查看&nbsp;</a>"
        href += "<a href='${ctx}/bpm/order_manage_3_4_full.jsp?orderId=" + model.orderId + "'>&nbsp;分单&nbsp;</a>";
        var array = new Array(
                ...
                new XTbody("order", model.surveyorUserName),
                new XTbody("order", model.orderUpdateTime),
