...
<SCRIPT LANGUAGE="JavaScript" >
    ...
    orderXTable.XTbodyArray = function (model) {
        var href = "";
        href += "<a style='border-right: 1px solid #dddddd' href='${ctx}/bpm/order_manage_4_5.jsp?userId=${userId}&orderId=" + model.orderId + "&estateId=" + model.estateId + "&buildingId=" + model.buildingId + "&unitId=" + model.unitId + "&houseId=" + model.houseId + "&sampleId=" + model.sampleId + "&orderValuatorDept=" + model.orderValuatorDept + "'>&nbsp;定值&nbsp;</a>"
