...
<c:set var="costValue" value="${param.costValue}" />
<c:set var="personValue" value="${param.personValue}" />
<!DOCTYPE html>
<html>
<head>
...
<form id="sampleForm" name="sampleForm" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <input id="marketRate" name="marketRate" type="range" min="0" max="1" step="0.01" value="0.8" placeholder="市场法估值" required="true" oninput="setValue(this)" />
        ...
        <tr>
            ...
            <td>
                <input type="number" id="profitValue" name="profitValue" value="${personValue}" placeholder="收益法估值" onchange="setSampleValue()" required="true" />
            </td>
            <td>
                收益法权重：
            </td>
            <td>
                <input id="profitRate" name="profitRate" type="range" min="0" max="1" step="0.01" value="0" placeholder="收益法权重" required="true" oninput="setValue(this)"/>
        ...
        <tr>
            ...
            <td>
                <input type="number" id="rate" name="rate" value="1" placeholder="权重和" readonly />
            </td>
        </tr>
        <tr>
            <td>
...
//        obj.nextElementSibling.innerHTML = obj.value;
    ...
    function setSampleValue() {
        ...
        dwr.util.setValue("rate", dwr.util.getValue("costRate") + dwr.util.getValue("marketRate") + dwr.util.getValue("profitRate"));
