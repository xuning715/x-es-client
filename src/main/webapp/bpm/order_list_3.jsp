...
<input type="hidden" id="orderState" name="orderState" value="3">
<SCRIPT LANGUAGE="JavaScript" >
    ...
    table += "<td style='width: 33.4%;'><a href='order_list_2_3.jsp?userId=${userId}' style='font-size: 18px;'>已约单</a></td>";
    table += "<td style='width: 33.4%; color: red; font-size: 18px;'>已完成</td>";
    table += "</tr></table>";
