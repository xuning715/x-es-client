...
<body>
<form id="orderForm">
    <input type="hidden" id="managerUserId" name="managerUserId" value="${userId}">
        ...
        <tr>
            ...
            <td>
                <select id="orderState" name="orderState">
                    ...
                    <option value="-1">查勘师退单</option>
                    <option value="-4">估价师退单</option>
                </select>
            </td>
            <td>
...
<SCRIPT LANGUAGE="JavaScript" >
    ...
    orderXTable.XTbodyArray = function (model) {
        ...
        var array = new Array(
                ...
                new XTbody("order", model.orderState == 1 ? "已关联" : model.orderState == -1 ? ("查勘师退单" + model.orderRollback) : model.orderState),
