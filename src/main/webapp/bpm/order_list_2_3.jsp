...
<input type="hidden" id="orderState" name="orderState" value="2">
<SCRIPT LANGUAGE="JavaScript" >
    var table = "<table><tr style='font-size: 15px'>";
    table += "<td style='width: 33.3%;'><a href='order_list_1_2.jsp?userId=${userId}' style='font-size: 18px;'>已分配</a></td>";
    table += "<td style='width: 33.3%; color: red; font-size: 18px;'>已约单</td>";
    ...
    orderXTable.XTbodyArray = function (model) {
        var href = "<table><tr><td><span style='font-size: 15px'>" + model.orderValuatorDept + "-" + model.orderCode + "-" + model.orderPurpose + "</span>&nbsp;&nbsp;&nbsp;";
        href += "<span style='font-size: 15px'>" + model.orderSurveyorTime + "</span><br>";
        ...
        href += "<td align='right'><a href='${ctx}/bpm/order_manage_2_3.jsp?userId=${userId}&orderId=" + model.orderId + "&orderState=" + model.orderState + "&estateId=" + model.estateId + "&buildingId=" + model.buildingId + "&unitId=" + model.unitId + "&houseId=" + model.houseId + "&sampleId=" + model.sampleId + "&orderValuatorDept=" + model.orderValuatorDept + "'><img width='' height='' src='${ctx}/images/arrow-right.png'/></a></td></tr></table>"
        var array = new Array(
